    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-24 items-center justify-between px-4">
          <Link to="/" className="flex items-center gap-5 transition-transform hover:scale-105">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white shadow-md ring-1 ring-border/10">
              <img src={appLogo} alt="AEROCHECK Logo" className="h-12 w-12 object-contain" />
            </div>
            <span className="text-3xl font-black tracking-tighter text-foreground">AEROCHECK</span>
          </Link>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-5 mb-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-white shadow-md ring-1 ring-border/10">
                  <img src={appLogo} alt="AEROCHECK Logo" className="h-11 w-11 object-contain" />
                </div>
                <span className="text-2xl font-bold tracking-tighter text-foreground">AEROCHECK</span>
              </div>
              <p className="text-sm text-muted-foreground">
